...
export default class AccessibilityModal extends Modal {
    static TYPE = "theme_so7ob/themesettings_modal";
    static TEMPLATE = "theme_so7ob/so7ob/accessibilitysettings_modal";

    constructor(root) {
        super(root);

        let request = Ajax.call([{
            methodname: 'theme_so7ob_getthemesettings',
            args: {}
        }]);
    ...
    registerEventListeners() {
        ...
        this.getModal().on(CustomEvents.events.activate, '[data-action="save"]', function() {
            let request = Ajax.call([{
                methodname: 'theme_so7ob_savethemesettings',
                args: {
