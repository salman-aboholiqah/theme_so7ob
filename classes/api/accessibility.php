...
class accessibility extends external_api {
    ...
    public static function sitecolor($action) {
        $params = self::validate_parameters(self::sitecolor_parameters(), ['action' => $action]);
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themeso7obsettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themeso7obsettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettingg:successfullysaved', 'theme_so7ob'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themeso7obsettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themeso7obsettings_enableaccessibilitytoolbar', false),
        ];
    }
