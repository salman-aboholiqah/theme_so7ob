...
/**
 * Class theme_so7ob_core_h5p_renderer.
 *
 ...
 */
class theme_so7ob_core_h5p_renderer extends \core_h5p\output\renderer {
    /**
    ...
    protected function get_style_url($content) {
        ...
        return \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
            "/$syscontext->id/theme_so7ob/hvp/$itemid/themehvp.css");
    }
}
