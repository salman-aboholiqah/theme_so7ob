...
namespace theme_so7ob\output;

use theme_config;
use core\context\course as context_course;
use moodle_url;
use html_writer;
use theme_so7ob\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = []) {
        $hasaccessibilitybar = get_user_preferences('themeso7obsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themeso7obsettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('so7ob_additional_header', 'lib.php', true, true);
    ...
    public function get_module_footer_callbacks_data() {
        $callbacks = get_plugins_with_function('so7ob_module_footer', 'lib.php', true, true);
    ...
    public function redirect_message($encodedurl, $message, $delay, $debugdisableredirect,
        ...
        $output .= $this->render_from_template('theme_so7ob/loading-overlay', ['encodedurl' => $encodedurl]);
    ...
    public function navbar(): string {
        $newnav = new \theme_so7ob\output\boostnavbar($this->page);
