...
/**
 * Theme so7ob functions and service definitions.
 *
 * @package    theme_so7ob
...
$functions = [
    'theme_so7ob_fontsize' => [
        'classname' => 'theme_so7ob\api\accessibility',
        'classpath' => 'theme_so7ob/classes/api/accessibility.php',
        'methodname' => 'fontsize',
        'description' => 'Increase or decrease the site font size.',
        'type' => 'write',
        'ajax' => true,
    ],
    'theme_so7ob_sitecolor' => [
        'classname' => 'theme_so7ob\api\accessibility',
